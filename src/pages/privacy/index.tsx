...
export default memo(function Privacy() {
  useEffect(() => {
    (window as any).gtag('config', process.env.NEXT_PUBLIC_GA_TRACKING_ID, {
      page_location: `${process.env.NEXT_PUBLIC_ENDPOINT}/privacy`,
      page_title: `${I18n.t('privacy policy')} | Qoodish`
    });
  }, []);
  ...
  return (
    <Layout hideBottomNav={true} fullWidth={false}>
      <Head>
        <title>{`${I18n.t('privacy policy')} | Qoodish`}</title>
        <link
          rel="canonical"
        ...
        <link
          rel="alternate"
          href={`${process.env.NEXT_PUBLIC_ENDPOINT}/privacy?hl=en`}
          hrefLang="en"
        />
        <link
          rel="alternate"
          href={`${process.env.NEXT_PUBLIC_ENDPOINT}/privacy?hl=ja`}
          hrefLang="ja"
        />
        <link
          rel="alternate"
        ...
        />
        <meta name="title" content={`${I18n.t('privacy policy')} | Qoodish`} />
        <meta name="description" content={I18n.t('meta description')} />
        <meta
          property="og:title"
          content={`${I18n.t('privacy policy')} | Qoodish`}
        />
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_ENDPOINT}/privacy`}
        />
